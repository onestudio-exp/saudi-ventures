...
func SeedCapability(ctx context.Context, a *app.App) error {
	...
	caps := []map[string]any{
		{"slug": "news-radar", "name_en": "News Radar", "name_ar": "رادار الأخبار", "kind": "capability", "enabled": true, "nav_order": int64(1), "nav_icon": "radar", "route": "/radar", "description_en": "Tracks and surfaces the latest Saudi venture-ecosystem news.", "description_ar": "يرصد آخر أخبار منظومة ريادة الأعمال السعودية.", "config": "{}", "workflow_steps": "[]"},
		...
		{"slug": "investment", "name_en": "Investment", "name_ar": "الاستثمار", "kind": "capability", "enabled": true, "nav_order": int64(3), "nav_icon": "trending-up", "route": "/investment", "description_en": "Maps investors, funds, and capital active in the Kingdom.", "description_ar": "يرسم خريطة المستثمرين والصناديق ورؤوس الأموال النشطة في المملكة.", "config": "{}", "workflow_steps": "[]"},
		{"slug": "funding", "name_en": "Funding & Deals", "name_ar": "التمويل والصفقات", "kind": "capability", "enabled": true, "nav_order": int64(4), "nav_icon": "handshake", "route": "/funding", "description_en": "Follows funding rounds, deals, and exits across the ecosystem.", "description_ar": "يتابع جولات التمويل والصفقات وعمليات الخروج في المنظومة.", "config": "{}", "workflow_steps": "[]"},
		{"slug": "sectors", "name_en": "Sectors & Market", "name_ar": "القطاعات والسوق", "kind": "capability", "enabled": true, "nav_order": int64(5), "nav_icon": "layers", "route": "/sectors", "description_en": "Analyzes sector activity and market trends in the Saudi market.", "description_ar": "يحلل نشاط القطاعات واتجاهات السوق في السوق السعودي.", "config": "{}", "workflow_steps": "[]"},
	}
	for _, c := range caps {
