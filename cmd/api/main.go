// Command api is the saudi-ventures HTTP entrypoint. It boots the shared togo stack
...
import (
	...
	"github.com/saudi-ventures/saudi-ventures/internal/server"
)
...
func main() {
	...
	k := a.Kernel
	fmt.Printf("→ saudi-ventures listening on %s  (GraphQL %s · REST %s · docs %s)\n",
